          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                buildMaterialButton(
                    " ArgonButtonExample", ArgonButtonExample()),
                ...
                buildMaterialButton(
                    "fluttertypeaheadPage", fluttertypeaheadPage()),
              ],
            ),
          ),
        ),
...
class fluttertypeaheadPage extends StatefulWidget {
  @override
  State<fluttertypeaheadPage> createState() => _MyAppState();
}

class _MyAppState extends State<fluttertypeaheadPage> {
