...
class GlassMorphic extends StatefulWidget {
...
class _MyHomePageState extends State<GlassMorphic> {
  @override
            ...
            child: Row(
              ...
              children: [
                RichText(
                  text: TextSpan(
                    text:
                    '${int.parse(likes) > 1000 ? int.parse(likes)
                        .toStringAsExponential() : int.parse(likes)}',
                    style: TextStyle(
                      fontFamily: 'RobotoMono',
